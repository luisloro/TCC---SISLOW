                        ...
                        lista.map(equipamento => {
                            return (
                                <tr>
                                    ...
                                    <Link className="btn btn-outline-primary btn-sm ms-1" to={`/editequipexib/${equipamento.id}`}> Edita Equipamento </Link>
...
export default ListaEquipamentosExibicao;